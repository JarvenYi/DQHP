...
def parse_option():
    ...
    parser.add_argument('--natsql_dataset_path', type = str, default = "./NatSQL/NatSQLv1_6/dev-natsql.json",
                        help = '''
                            ...
                            ''')
    parser.add_argument('--output_dataset_path', type = str, default = "./data/preprocessed_data/preprocessed_dev_natsql.json",
...
def main(opt):
    ...
    for natsql_data, data in tqdm(zip(natsql_dataset, dataset)):
        ...
        if opt.mode == "test":
            ...
            sql_skeleton = extract_skeleton(norm_sql, db_schemas[db_id]).strip()    # extract the skeleton of sql and natsql, such as "select _ from _ where _"
