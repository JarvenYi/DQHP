...
def parse_option():
    ...
    parser.add_argument('--seed', type = int, default = 42,
                        help = 'random seed.')
    parser.add_argument('--save_path', type = str, default = "models/text2sql_schema_item_classifier_Jarven",
    ...
    parser.add_argument('--use_contents', action='store_true',#action='store_true',#default=True,
...
def _train(opt):
    ...
    best_table_score, best_column_score = 0, 0
        ...
        for batch in train_dataloder:
            ...
            if train_step % num_checkpoint_steps == 0:
                ...
                if toral_auc_score >= best_score:
                    ...
                    best_table_score = table_auc
                    best_column_score = column_auc
    ...
    print("best table auc:", best_table_score)
    print("best column auc:", best_column_score)
