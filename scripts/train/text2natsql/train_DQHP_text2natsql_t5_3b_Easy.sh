...
#   --epochs 32 \
#   --seed 42 \
#   --save_path "../../../autodl-tmp/DQCP/models/DQCP-3B-NatSQL/Easy" \
#   --tensorboard_save_path "./tensorboard_log/DQCP/Easy_DQCP_3B_NatSQL" \
#   --model_name_or_path "../../../autodl-tmp/DQCP/models/text2natsql-t5-3b/checkpoint-78302" \
#   --use_adafactor \
#   --mode train \
#   --train_filepath "./data/preprocessed_data/preprocessed_by_resd_hardness_natsql/Easy_resd_hardness_train_dataset.json" \
#   --output "Easy_predicted_natsql.txt"
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --device "1" \
    --seed 42 \
    --save_path "./models/DQCP-3B-NatSQL/Easy" \
