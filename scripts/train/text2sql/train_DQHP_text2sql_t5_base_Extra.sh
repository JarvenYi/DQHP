...
#    --epochs 64 \
#    --seed 42 \
#    --save_path "./models/DQHP-base/Extra-hard" \
#    --tensorboard_save_path "./tensorboard_log/DQHP/Extra-hard_refined_hardness_text2sql_base" \
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --seed 42 \
    --save_path "./models/DQHP-base/Extra-hard" \
    --eval_results_path "./eval_results/DQHP-base-Extra-hard" \
    --mode eval \
    ...
    --target_type "sql" \
    --output "./predictions/Extra-hard_DQHP_base_predicted_sql.txt"