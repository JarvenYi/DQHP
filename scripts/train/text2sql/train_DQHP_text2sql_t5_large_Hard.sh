...
#    --epochs 64 \
#    --seed 42 \
#    --save_path "./models/DQHP-large/Hard" \
#    --tensorboard_save_path "./tensorboard_log/DQHP/Hard_refined_hardness_text2sql_large" \
#    --model_name_or_path "./models/text2sql-t5-large/checkpoint-30576" \
#    --use_adafactor \
#    --mode train \
#    --train_filepath "./data/preprocessed_data/preprocessed_by_refined_hardness/Hard_refined_hardness_train_dataset.json" \
#    --output "./predictions/Hard_predicted_sql.txt"
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --seed 42 \
    --save_path "./models/DQHP-large/Hard" \
    --eval_results_path "./eval_results/DQHP-large-Hard" \
    --mode eval \
    ...
    --target_type "sql" \
    --output "./predictions/Hard_DQHP_large_predicted_sql.txt"