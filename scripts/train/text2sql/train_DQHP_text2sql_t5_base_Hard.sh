...
#    --epochs 64 \
#    --seed 42 \
#    --save_path "./models/DQHP-base/Hard" \
#    --tensorboard_save_path "./tensorboard_log/DQHP/Hard_refined_hardness_text2sql_base" \
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --seed 42 \
    --save_path "./models/DQHP-base/Hard" \
    --eval_results_path "./eval_results/DQHP-base-Hard" \
    --mode eval \
    ...
    --target_type "sql" \
    --output "./predictions/Hard_DQHP_base_predicted_sql.txt"