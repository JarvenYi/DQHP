...
#    --epochs 64 \
#    --seed 42 \
#    --save_path "./models/DQHP-large/Easy" \
#    --tensorboard_save_path "./tensorboard_log/DQHP/Easy_refined_hardness_text2sql_large" \
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --seed 42 \
    --save_path "./models/DQHP-large/Easy" \
    --eval_results_path "./eval_results/DQHP-large-Easy" \
    --mode eval \
    ...
    --target_type "sql" \
    --output "./predictions/Easy_DQHP_large_predicted_sql.txt"